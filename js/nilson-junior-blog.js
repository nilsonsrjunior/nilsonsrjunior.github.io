...
$(function() {
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            $.ajax({
                url: "//formspree.io/nilsonsrjunior@gmail.com",
                type: "POST",
                data: {
                  message: message,
                  name: name,
                  _subject: "nilsonsrjunior.net - Contato - " + name,
                  _replyto: email
                },
                dataType: "json",
                success: function() {
                ...
                error: function() {
                    ...
                    $('#success > .alert-danger').html("<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;")
                        .append("</button>");
                    $('#success > .alert-danger').append("<strong>Desculpe " + firstName + ", parece que meu servidor de e-mail parou de responder. Por favor, tente mais tarde.!");
